...
3.  **Track Everything**: Create a new task in the Status Tracker immediately upon receiving a new assignment or request from the user. Break down complex work into phases and todos.
